...
enum PAVO_REG_INDEX {
	...
	REG_ANTI_WINDOW_GET,
	REG_ANTI_WINDOW_SET,
	REG_ANTI_WINDOW_GET_15,
	REG_ANTI_WINDOW_SET_15
};
...
static const unsigned char PAVO_REG[][PAVO_REG_LEN]  = {
	...
	{ 0xEB, 0x90, 0xB0, 0x82 },   //REG_ANTI_MODE_WINDOW82
	{ 0xEB, 0x90, 0xA0, 0x82 },   //REG_ANTI_MODE_WINDOW82
    { 0xEB, 0x90, 0xB0, 0x15 },   //REG_ANTI_MODE_WINDOW15  from fw ver 3.0.1.0
    { 0xEB, 0x90, 0xA0, 0x15 }   //REG_ANTI_MODE_WINDOW15
};
